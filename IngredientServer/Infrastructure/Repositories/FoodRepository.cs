...
public class FoodRepository(ApplicationDbContext context, IUserContextService userContextService, ITimeService timeService)
    : BaseRepository<Food>(context, userContextService, timeService), IFoodRepository
{
