...
namespace IngredientServer.Core.Entities
{
    ...
    public class Food : BaseEntity
    {
        ...
        [Required] public FoodCategory Category { get; set; } = FoodCategory.Other;

        public CookingMethod CookingMethod { get; set; } = CookingMethod.Other;

        [StringLength(2000)] public string? Recipe { get; set; }

        [Range(1, 1440)] public int? PreparationTimeMinutes { get; set; }
